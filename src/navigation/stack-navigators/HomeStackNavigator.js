...
const youtubeUrl1 = 'https://www.youtube.com/watch?v=of7rgBIiNe8&pp=ygUSbWlsaW5kIHNhbXBnYW9ua2Fy';
...
const Home = ({navigation}) => (
  <ScrollView ref={ref => this.scrollViewRef = ref}>
    <View style={{ flex: 1, justifyContent: 'flex-start', paddingTop: 22, paddingLeft: 24, paddingRight: 24, paddingBottom: 22, backgroundColor: '#FBEAFF', }}>
      ...
      <Text style={styles.headerText2}>About Milind Sampgaonkar</Text>
      {aboutPages.map((aboutPage, aIndex)=> {
        const {text, navigationText} = aboutPage;
        return <Pressable key={`aboutPage-${navigationText}`} style={{marginTop: 22}} onPress={() => navigation.navigate(navigationText)}>
...
const HomeStackNavigator = () => {
  return (
    <Stack.Navigator screenOptions={{
      ...
      <Stack.Screen name={screens.EducationQualification} component={EducationQualification} />
      <Stack.Screen name={screens.ProfessionalProfile} component={ProfessionalProfile} />
